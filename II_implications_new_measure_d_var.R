...
# Combine the plots
combined_plot <- plot_sumshck / plot_lnipnsa / plot_lnppinsa +
  plot_layout(guides = "collect") +
  plot_annotation(title = "FIGURE 9. THE EFFECT OF MONETARY POLICY IN A VAR USING THE NEW MEASURE OF MONETARY POLICY")
